...
package com.archive.store.viewmodel.blacklist
...
import com.archive.store.compose.ui.commons.SortFilterPrefKeys
import com.archive.store.compose.ui.commons.SortFilterState
import com.archive.store.compose.ui.commons.applyFilter
import com.archive.store.compose.ui.commons.applySort
import com.archive.store.compose.ui.commons.loadSortFilterState
import com.archive.store.compose.ui.commons.save
import com.archive.store.data.event.BusEvent
import com.archive.store.data.helper.UpdateHelper
import com.archive.store.data.model.BlacklistAppItem
import com.archive.store.data.providers.BlacklistProvider
import com.archive.store.util.CertUtil
...
class BlacklistViewModel @Inject constructor(
    ...
    private val isArchiveOnlyFilterEnabled =
        Preferences.getBoolean(context, Preferences.PREFERENCE_FILTER_ARCHIVE_ONLY, false)
    ...
    private fun isFiltered(packageInfo: PackageInfo): Boolean = when {
        ...
        isArchiveOnlyFilterEnabled -> !CertUtil.isArchiveStoreApp(
            context,
    ...
    fun blacklist(packageName: String) {
        ...
        ArchiveApp.Companion.events.send(BusEvent.Blacklisted(packageName))
    }
