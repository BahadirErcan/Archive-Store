...
package com.archive.store.compose.ui.spoof
...
import com.archive.store.compose.ui.spoof.menu.MenuItem
import com.archive.store.compose.ui.spoof.menu.SpoofMenu
import com.archive.store.compose.ui.spoof.navigation.SpoofPage
import com.archive.store.viewmodel.spoof.SpoofViewModel
            ...
            when (menuItem) {
                ...
                MenuItem.EXPORT -> {
                    docExportLauncher.launch(
                        "archive_store_${Build.BRAND}_${Build.DEVICE}.properties"
                    )
                }
            }
        }
