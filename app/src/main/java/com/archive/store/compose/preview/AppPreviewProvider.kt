...
class AppPreviewProvider : PreviewParameterProvider<App> {
    companion object {
        ...
        private const val DESCRIPTION = """
            <p>Archive Store is an unofficial, FOSS client to Google Play with an elegant design. Archive Store allows users to download, update, and search for apps like the Play Store. It works perfectly fine with or without Google Play Services or microG.</p>
