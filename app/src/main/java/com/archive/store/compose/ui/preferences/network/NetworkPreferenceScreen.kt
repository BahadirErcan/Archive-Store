...
package com.archive.store.compose.ui.preferences.network
...
import com.archive.store.util.Preferences.PREFERENCE_MICROG_AUTH
import com.archive.store.util.Preferences.PREFERENCE_PROXY_INFO
import com.archive.store.util.Preferences.PREFERENCE_PROXY_URL
import com.archive.store.util.Preferences.PREFERENCE_VENDING_VERSION
import com.archive.store.util.remove
import com.archive.store.util.save
import com.archive.store.viewmodel.preferences.ProxyURLViewModel
