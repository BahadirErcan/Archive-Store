...
import com.archive.store.compose.ui.commons.StreamBrowseScreen
import com.archive.store.compose.ui.details.AppDetailsScreen
import com.archive.store.compose.ui.dev.DevProfileScreen
import com.archive.store.compose.ui.dispenser.DispenserScreen
import com.archive.store.compose.ui.downloads.DownloadsScreen
import com.archive.store.compose.ui.favourite.FavouriteScreen
import com.archive.store.compose.ui.installed.InstalledScreen
import com.archive.store.compose.ui.main.MainScreen
import com.archive.store.compose.ui.onboarding.OnboardingScreen
import com.archive.store.compose.ui.preferences.NotificationPreferenceScreen
import com.archive.store.compose.ui.preferences.SettingsScreen
import com.archive.store.compose.ui.preferences.UIPreferenceScreen
import com.archive.store.compose.ui.preferences.installation.InstallationPreferenceScreen
import com.archive.store.compose.ui.preferences.installation.InstallerScreen
import com.archive.store.compose.ui.preferences.network.NetworkPreferenceScreen
import com.archive.store.compose.ui.preferences.security.SecurityPreferenceScreen
import com.archive.store.compose.ui.preferences.updates.SourceFiltersScreen
import com.archive.store.compose.ui.preferences.updates.UpdatesPreferenceScreen
import com.archive.store.compose.ui.search.SearchScreen
import com.archive.store.compose.ui.splash.SplashScreen
import com.archive.store.compose.ui.spoof.SpoofScreen
...
fun NavDisplay(startDestination: NavKey) {
    ...
    // Check every time the screen resumes in case microG was removed while Archive was in background.
    LifecycleEventEffect(Lifecycle.Event.ON_RESUME) {
        if (isMicroGAuthInvalidated()) handleMicroGRemoved()
    }

    // Also react immediately if the GMS package is uninstalled while Archive is in the foreground.
    LaunchedEffect(Unit) {
        ArchiveApp.events.installerEvent.collect { event ->
    ...
    LaunchedEffect(Unit) {
        ArchiveApp.events.authEvent.collect { event ->
