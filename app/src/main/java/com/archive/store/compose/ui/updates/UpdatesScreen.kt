...
package com.archive.store.compose.ui.updates
...
import com.archive.store.compose.composable.ShimmerUpdateItem
import com.archive.store.compose.composable.app.AppUpdateItem
                    ...
                    if (selfEntries.isNotEmpty()) {
                        ...
                        items(
                            ...
                            AppUpdateItem(
                                ...
                                // Served from the Archive OSS feed, not Play — there is
