...
import com.archive.store.compose.ui.preferences.network.SingleChoiceDialog
...
private fun ScreenContent(
    ...
    val filterArchiveOnly = remember(refreshKey) {
        Preferences.getBoolean(context, PREFERENCE_FILTER_ARCHIVE_ONLY)
    }
        ...
        LazyColumn(
            ...
            item {
                ListItem(
                    ...
                    supportingContent = {
                        Text(sourceFiltersSummary(filterArchiveOnly, installerCount))
                    }
                )
            }
            item { HorizontalDivider() }
