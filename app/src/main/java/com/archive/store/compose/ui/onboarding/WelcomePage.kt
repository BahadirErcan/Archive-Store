...
import com.archive.store.compose.ui.about.AboutDialog
...
fun WelcomePage() {
    ...
    PageContent(onAboutArchive = { shouldShowAboutDialog = true })
}

@Composable
private fun PageContent(onAboutArchive: () -> Unit = {}) {
    ...
    val links = listOf(
        Link(
            ...
            subtitle = stringResource(R.string.about_archive_store_subtitle),
