...
import com.archive.extensions.setAppTheme
import com.archive.store.data.event.EventFlow
import com.archive.store.data.helper.DownloadHelper
import com.archive.store.data.helper.UpdateHelper
import com.archive.store.data.receiver.PackageManagerReceiver
...
@HiltAndroidApp
class ArchiveApp : Application(), Configuration.Provider, SingletonImageLoader.Factory {
