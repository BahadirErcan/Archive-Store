...
import com.archive.Constants.PACKAGE_NAME_APP_GALLERY
import com.archive.Constants.PACKAGE_NAME_GMS
import com.archive.extensions.TAG
import com.archive.extensions.generateX509Certificate
...
import com.archive.store.util.PackageUtil.getPackageInfo
...
object CertUtil {
    ...
    fun isArchiveStoreApp(context: Context, packageName: String): Boolean {
