...
import com.archive.Constants.FLAVOUR_PRELOAD
import com.archive.Constants.FLAVOUR_VANILLA
...
object PackageUtil {
    ...
    /**
     * Build-level eligibility for Archive Store's self-update: vanilla / preload flavors
