...
object Constants {
    ...
    // The anonymous token dispenser is served behind a Cloudflare WAF rule that
    // only accepts the original Aurora Store User-Agent. It must not follow the
    // renamed application id, or the dispenser rejects the request.
    const val DISPENSER_USER_AGENT = "com.aurora.store"
